...
- Enable WAP2 to encrypt the wifi connection in the office. For added security, set up a segregated wifi connection for guest versus staff (Refer to chapter 7 - Network Security for best practices in securing wifi). 
